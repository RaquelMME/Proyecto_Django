"""
Django settings for grupo9_cac project.
...
SECRET_KEY = 'django-insecure-i4_p*xd*%mnny&=y&vl$@4n3a+^f&=k()f(*f1q*qilnzhdesz'
...
WSGI_APPLICATION = 'grupo9_cac.wsgi.application'
